...
public class AdminCouponSetting extends JPanel {
    ...
    private void showDialog(kiosk.adminVO.CouponSettingVO coupon) {
        AdminCouponDialog dialog = new AdminCouponDialog(mainFrame, SwingUtilities.getWindowAncestor(this),
                AdminCouponSetting.this, coupon);
    ...
    public void loadCouponData() {
        ...
        try {
            ...
            for (kiosk.adminVO.CouponSettingVO coupon : couponList) {
                couponModel.addRow(new Object[] { coupon.getCouponSettingName(), coupon.getProductName(),
                        coupon.getCouponSettingGrade(), coupon.getCouponSettingRate(), coupon.getCouponSettingFixed(),
