...
public class AdminUserManagementPanel extends JPanel {
  ...
  public AdminUserManagementPanel(MainFrame mainFrame) {
    ...
    // 회원관리 레이블
    JLabel titleLabel = new JLabel("회원관리", JLabel.CENTER);
    titleLabel.setFont(new Font("aria", Font.BOLD, 35));
    titleLabel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10)); //여백
    ...
    JButton searchByNumberButton = new JButton("번호검색");
